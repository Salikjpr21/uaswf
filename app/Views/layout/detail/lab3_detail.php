...
<head>
    ...
    <title>Computer Network and Instrumentation</title>
    ...
    <main id="main">
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                ...
                <ol>
                    <li><a href="/">Home</a></li>
                    <li>Computer Network and Instrumentation</li>
                </ol>
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="assets/img/foto/network-1.jpg" alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/img/foto/network-2.jpg" alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/img/foto/network-3.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/fasilitas/router.png" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/fasilitas/voltmeter.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/fasilitas/lan.jpg" alt="">
                                </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="portfolio-description">
                            <h2>Computer Network and Instrumentation</h2>
                            <p>
                                in this laboratory, you can use various existing facilities to help you in work around the network, making it easier for you to learn how to connect connections between routers.
                            </p>
                        </div>
                    </div>
