    ...
    <section id="topbar" class="d-flex align-items-center">
        <div class="container d-flex justify-content-center justify-content-md-between">
            ...
            <div class="social-links d-none d-md-block">
                ...
                <a href="https://www.instagram.com/salik_jpr21/?hl=en" class="instagram" class="instagram"><i class="bi bi-instagram"></i></a>
    ...
    <main id="main">
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                ...
                <ol>
                    <li><a href="/">Home</a></li>
                    <li>Softwere Engineering</li>
                </ol>
                <h2>Softwere Engineering</h2>
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="assets/img/foto/foto-1.jpg" alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/img/foto/foto-2.jpg" alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/img/foto/foto-3.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img src="assets/img/foto/softwere-1.jpg" alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/img/foto/softwere-2.jpg" alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/img/foto/softwere-3.jpg" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="portfolio-description">
                            <h2>Softwere Engineering</h2>
                            <p>
                                in this laboratory, you can use various existing facilities to help you in the coding process, making it easier for you to build a website program.
                            </p>
                        </div>
                    </div>
